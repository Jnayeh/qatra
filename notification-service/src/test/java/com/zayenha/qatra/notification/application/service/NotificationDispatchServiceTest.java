...
class NotificationDispatchServiceTest {
    ...
    @BeforeEach
    void setUp() {
        lenient().when(inAppChannel.type()).thenReturn(NotificationChannelType.IN_APP);
    ...
    void shouldSkipDuplicateByCorrelationId() {
        ...
        var payload = new NotificationPayload(1L, "TEST", "Title", "Body", null, "dup-corr", Instant.now());
    ...
    void shouldDispatchToMatchingChannel() {
        ...
        var payload = new NotificationPayload(1L, "TEST", "Title", "Body", null, "corr-1", Instant.now());
        dispatchService.dispatch(payload, "IN_APP");
    ...
    void shouldSkipNonConfiguredChannel() {
        ...
        var payload = new NotificationPayload(1L, "TEST", "Title", "Body", null, "corr-2", Instant.now());
